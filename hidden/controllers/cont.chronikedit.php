...
if (isset($_SESSION["dataMark"]) && $_SESSION['dataMark'] == 0) {
    ...
    $_SESSION['chronikID'] = $data['anzahl'] - $pageNumber;


    echo "PN" . $_SESSION['pageNumber'];
    echo "PS" . $_SESSION['pageSize'];
    echo "PID" . $_SESSION['chronikID'];
...
//        }
    ...
    if (isset($_SESSION['dataMark']) && $_SESSION['dataMark'] == 3) {
        $query = "UPDATE HLBchronik SET released = '$_POST[released]', Datum = '$_POST[Datum]', KG = '$_POST[KG]', KVE = '$_POST[KVE]', KM = '$_POST[KM]', KHI = '$_POST[KHI]', K = '$_POST[K]', Headline = '$_POST[Headline]', Text1 = '$_POST[Text1]', Text2 = '$_POST[Text2]', Text3 = '$_POST[Text3]', Text4 = '$_POST[Text4]', Text5 = '$_POST[Text5]' WHERE HLBchronik . chronikID = " . $_SESSION['chronikID'] . "";
    ...
    if (isset($_SESSION["dataMark"]) && $_SESSION['dataMark'] == 1) {
        ...
        $query = "INSERT INTO HLBchronik (released, Datum, KG, KVE, KM, KHI, K, Headline, Text1, Text2, Text3, Text4, Text5) VALUES ('', NULL, '', '', '', '', '', '', '', '', '', '', '')";
