            ...
            <div class="spalte">
                <div class="marg pressemitteilung">
                    ...
                    <?php foreach ($chronik as $pm) { ?>
                        <p>
                            <a target= "_blank" href="/chronikedit/#<?php echo $pm['chronikID']?>"><span class="ChronikDate"><?php $date=date_create($pm['Datum']); echo date_format($date,"d.m.Y");?></span><span class="titelChronik"><?php echo $pm['Headline']?></span></a>
                        </p>
                    <?php } ?>
                    <p>
