        ...
        <div id="backgroundWrapper" class="backgroundWrapper">
            ...
            <div class="wrapper">
                <header class="clearfix">
                    <a href="/home"><img class="logo" src="/images/hlb_Logo_100_jahre_lang.svg" alt="FDP_Fraktion_WEBsite" title="Zurück zur Startseite 'Home'"/>
                        <span class="text-hidden btn_login">100 Jahre Lehrerbau</span>
                    </a>
                    <div class="wappen">
                    ...
                    <div class="menu">
                        ...
                        <nav id="main_nav">
                            <ul>
                                <li>
                                    <a class="nav_mark<?php echo ( $page === 'chronik' ? ' navActiv' : ''); ?>" href="<?php echo ( $page === 'home' ? '/chronik"' : '/chronik"'); ?>">Chronik</a>
                                </li>
<!--                                <!--<li>-->
<!--                                    <a class="nav_mark--><?php //echo ( $page === 'requestinquiry' ? ' navActiv' : ''); ?><!--" href="--><?php //echo ( $page === 'home' ? '/requestinquiry' : '/requestinquiry"'); ?><!--">Unsere Themen</a>-->
<!--                                </li>-->
<!--                                <li>-->
